...
enum SkillEnum;
enum MonsterLineID;
enum PlayerAnimModes;
enum MonAnimModes;
enum UniqueMonsterLineID;
...
enum UniqueMonsterLineID : uint32_t {
    Bishibosh = 0,
    Bonebreak = 1,
    Coldcrow = 2,
    Rakanishu = 3,
    ...
    TheCountess = 6,
    PitspawnFouldog = 7,
    FlamespiketheCrawler = 8,
    Boneash = 9,
    Radament = 10,
    BloodwitchtheWild = 11,
    Fangskin = 12,
    Beetleburst = 13,
    Leatherarm = 14,
    ColdwormtheBurrower = 15,
    FireEye = 16,
    DarkElder = 17,
    TheSummoner = 18,
    AncientKaatheSoulless = 19,
    TheSmith = 20,
    WebMagetheBurning = 21,
    WitchDoctorEndugu = 22,
    Stormtree = 23,
    SarinatheBattlemaid = 24,
    IcehawkRiftwing = 25,
    IsmailVilehand = 26,
    GelebFlamefinger = 27,
    BremmSparkfist = 28,
    ...
    TheTormentor = 33,
    Taintbreeder = 34,
    RiftwraiththeCannibal = 35,
    InfectorofSouls = 36,
    LordDeSeis = 37,
    GrandVizierofChaos = 38,
    TheCowKing = 39,
    Corpsefire = 40,
    TheFeatureCreep = 41,
    SiegeBoss = 42,
    AncientBarbarian1 = 43,
    AncientBarbarian2 = 44,
    AncientBarbarian3 = 45,
    AxeDweller = 46,
    BonesawBreaker = 47,
    DacFarren = 48,
    MegaflowRectifier = 49,
    EyebackUnleashed = 50,
    ThreashSocket = 51,
    Pindleskin = 52,
    SnapchipShatter = 53,
...
struct D2UnitStrc {
    ...
    MonsterLineID LineID; //0x0004
    uint32_t ID; //0x0008
    PlayerAnimModes AnimationMode; //0x000C
    union //0x0010
    {
