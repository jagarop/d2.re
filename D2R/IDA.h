...
struct Grid;
struct D2InventoryGridArrayStrc;
struct unkGameStrc;
struct D2ItemExtraDataStrc;
...
struct D2MonsterDataStrc
{
    ...
    D2C_MonsterTypeFlags TypeFlags;	//0x001A
...
struct D2UnitHashTableStrc {
    D2UnitStrc* Units[128]; //0x0000 
};

struct D2UnitHashTablesStrc {
    D2UnitHashTableStrc Players; //0x0000
    D2UnitHashTableStrc Monsters; //0x0400
    D2UnitHashTableStrc Objects; //0x0800
    D2UnitHashTableStrc Missiles; //0x0C00
    D2UnitHashTableStrc Items; //0x1000
    D2UnitHashTableStrc Tiles; //0x1400 
};
...
struct D2ItemDataStrc
{
    ...
    D2C_ItemInvPage InvPage;	//0x0055
...
struct D2InventoryGridArrayStrc {
    D2InventoryGridStrc Equipped; //0x0000
    D2InventoryGridStrc Belt; //0x0020
    D2InventoryGridStrc Inventory; //0x0040
    D2InventoryGridStrc TradeReceive; //0x0060
    D2InventoryGridStrc TradeOffer; //0x0080
    D2InventoryGridStrc Cube; //0x00A0
    D2InventoryGridStrc Stash; //0x00C0
};
